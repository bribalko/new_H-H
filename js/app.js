(() => {
    ...
    const spollersItems = document.querySelectorAll(".spollers__summary");
    const spollerIcon = document.querySelector(".spoller__icon");
    spollersItems.forEach((item => {
        item.addEventListener("click", (() => {
            spollerIcon.classList.toggle("--active-btn");
        }));
    }));
    function menuInit() {
